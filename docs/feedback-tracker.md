...
| P1 | LAE-009 | Overhaul every Device Engine | Port approved web-reference behavior, then apply the shared Surface/Advanced UX, visual system, deeper presets, metering, smoothing, resizing, and QA standard. | In progress; Tape, Transmission, and Comms first slices implemented |
